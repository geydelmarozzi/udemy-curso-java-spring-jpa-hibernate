...
public class UserService {
	...
	//o Método Save já retorno um objeto do tipo User que foi salvo!
	...
	public User update(Long id, User obj) {
		try {
			//Prepara o objeto monitorado para depois ir no banco efetuar a alteração... mais eficiente que o findById
